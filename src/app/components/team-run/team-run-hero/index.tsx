        ...
        <div className="flex flex-col gap-6 Xxl:pb-20 pb-10">
          <div className="flex items-start gap-2 md:gap-6">
            ...
            <p className="text-white/70 max-w-md">
              Where teamwork meets{" "}
              <span className="text-primary">glow-in-the-dark fun</span>— Bhaag
              Milkar Bhaag!
            </p>
          </div>
          <div className="flex flex-col lg:flex-row items-start lg:items-end gap-4">
            <h1 className="large-heading">Team Run</h1>
            <div>
              <NavigationLink
                navigationTitle=""
                navigationLink="/team-run"
                transform={false}
              />
            </div>
          </div>
