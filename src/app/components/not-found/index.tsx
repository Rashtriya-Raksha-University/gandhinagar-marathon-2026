...
const NotFound = () => {
  return (
    <section className="h-screen flex justify-center items-center border-t-4 border-primary">
      <div className="container">
        <div className="flex flex-col gap-10 justify-center items-center ">
          ...
          <Link
            href="/"
            className="group flex gap-3 items-center w-fit bg-primary hover:bg-secondary border border-primary hover:border-white/30 rounded-full transition-all duration-200 ease-in-out"
          >
