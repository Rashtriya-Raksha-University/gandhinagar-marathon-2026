        ...
        <div className="container">
          <div className="flex flex-col xl:flex-row gap-8">
            <div className="max-w-xl w-full">
              <h2 className="text-56">BCORE Gandhinagar Marathon</h2>
            </div>
            <div className="flex flex-col gap-8">
              <p className="text-secondary dark:text-white text-lg leading-relaxed">
                ...
                Gandhinagar - stretching from the historic Salt Mount to the
                refreshing green landscapes of Swarnim Park. With a touch of
              ...
              <p className="text-secondary dark:text-white text-lg leading-relaxed">
                Join us during the 1st EDITION of the BCORE Gandhinagar
                Marathon, the to-be fastest and exciting marathon in India! No
                city in India has ever hosted a Marathon event by an Olympic
                Centre. With BCORE, the first Indian Olympic Centre, you will
                experience a Marathon like no other.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-secondary dark:text-white/70 max-w-2xl mx-auto">
              ...
              in this historic marathon event.
            </p>
          </div>
